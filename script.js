  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'text' || tagName === 'textarea') && field.minLength && value.length < field.minLength) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "MJ Marble משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1bc117a7-5213-4120-949b-9abbe0054baa',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1bc117a7-5213-4120-949b-9abbe0054baa';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1bc117a7-5213-4120-949b-9abbe0054baa';
